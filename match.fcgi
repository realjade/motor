...
"""
将 match 以 FastCGI Server 的方式运行。
...
APP_NAME = 'match'
APP_INST_NAME = '20130904'

# 命令行参数
parser = argparse.ArgumentParser(description=u'Run an match FastCGI server')
...
if __name__ == '__main__':
    ...
    daemon = matchDaemon(gen_pidfile(args.port))
